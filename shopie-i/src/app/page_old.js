...
export default function Home() {
        ...
        <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {activeTab === 'overview' && (
            <div>
              ...
              {/* High Priority Products Preview */}
              {report.high_priority_products.length > 0 && (
                <div className="mb-8">
                  <h2 className="text-xl font-semibold text-gray-900 mb-4">
                    Top Opportunities ({report.high_priority_products.length})
                  </h2>
                  <div className="space-y-4">
                    {report.high_priority_products.slice(0, 3).map((evaluation, index) => (
                      <ProductCard 
                        key={index} 
                  ...
                  {report.high_priority_products.length > 3 && (
                    <div className="mt-4 text-center">
                      <button 
                        onClick={() => setActiveTab('product-list')}
                        className="text-blue-600 hover:text-blue-800 text-sm font-medium"
                      >
                        View all {report.high_priority_products.length} products →
                      </button>
                    </div>
                  )}
                </div>
          ...
          {activeTab === 'trend-predictions' && (
            <div className="text-center py-12">
              <div className="mb-8">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Trend Predictions</h2>
                <p className="text-gray-600 max-w-2xl mx-auto mb-8">
                  Advanced trend analysis and future predictions are being developed. 
                  This section will include predictive analytics, market forecasting, and trend projections.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                  <div className="bg-white rounded-lg shadow p-6">
                    <h3 className="font-semibold text-gray-900 mb-2">Market Forecasting</h3>
                    <p className="text-sm text-gray-600">AI-powered predictions for market trends and consumer behavior</p>
                  </div>
                  <div className="bg-white rounded-lg shadow p-6">
                    <h3 className="font-semibold text-gray-900 mb-2">Seasonal Analysis</h3>
                    <p className="text-sm text-gray-600">Identify seasonal patterns and optimal timing for product launches</p>
                  </div>
                  <div className="bg-white rounded-lg shadow p-6">
                    <h3 className="font-semibold text-gray-900 mb-2">Competitive Intelligence</h3>
                    <p className="text-sm text-gray-600">Track competitor movements and market positioning strategies</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Report Metadata - shown on all tabs */}
  ...
  function getTabTitle(tab) {
    switch(tab) {
      case 'overview': return 'Product Trend Dashboard';
      case 'product-list': return 'Product List';
      case 'visual-data': return 'Visual Data';
      case 'trend-predictions': return 'Trend Predictions';
      default: return 'Product Trend Dashboard';
    }
  }
  
  function getTabDescription(tab) {
    switch(tab) {
      case 'overview': return 'Smart shopping assistant for business buyers';
      case 'product-list': return 'All evaluated products with detailed analysis';
      case 'visual-data': return 'Charts and graphs for data visualization';
      case 'trend-predictions': return 'Future trend analysis and predictions';
      default: return 'Smart shopping assistant for business buyers';
    }
  }
